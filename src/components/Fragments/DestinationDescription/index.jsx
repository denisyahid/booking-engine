    ...
    return (
        <div id='tickets' className='w-full max-w-6xl mx-auto border border-gray-300 m-5 p-4 my-10 flex flex-col lg:flex-row gap-4'>
            ...
            <div className='flex-1 border-gray-300 space-y-3'>
                ...
                {destination.destination_rates && (
                    <div className='flex justify-between'>
                        <div>
                            <p className='text-sm text-gray-600'>Starts from</p>
                            <div className='flex items-baseline gap-2'>
                                <p className='text-red-600 font-bold text-lg'>{formatRupiah(destination.destination_rates[0].price)}</p>
                            </div>
                        </div>
                        <div className='flex items-center'>
                            <button className='bg-orange-500 text-white px-3 py-1 font-semibold'>Buy Tickets</button>
                        </div>
                    </div>
                )}
