...
export default function Hero({ roomsByHotel = [] }) {
    ...
    const handlePrev = () => {
        setCurrentIndex((prevIndex) =>
            (prevIndex - 1 + allRooms.length) % allRooms.length
        );
    };
        ...
        (roomsByHotel.length > 0 || rooms.length > 0) && (
            <div className='md:py-5 bg-white'>
                <section className='max-w-6xl mx-auto py-4 overflow-hidden relative'>
                    <h2 className='font-sans p-5 md:p-0 text-2xl md:text-3xl md:mb-8'>
                        Latest Room Deals
                    </h2>
                                    ...
                                    >
                                        <div className='bg-white shadow overflow-hidden'>
                                            ...
                                            <div className='pt-4 p-4'>
                                                <h3 className='font-sans text-lg mb-2'>
                                                    {room.name}
                                                </h3>
